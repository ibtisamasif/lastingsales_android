...
public class BlankFragment3_2 extends TabFragment implements LoaderManager.LoaderCallbacks<List<Object>> {
    ...
    public BlankFragment3_2() {
    }

    public static BlankFragment3_2 newInstance() {
        BlankFragment3_2 fragment = new BlankFragment3_2();
...
//        args.putLong("someId", id);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        args = new Bundle();
        args.putString(LeadsLoader.KEY_LEADS_TO_LOAD, LeadsLoader.INPROGRESS_LEADS);
        getLoaderManager().initLoader(LEADS_LOADER_ID, args, BlankFragment3_2.this);
    }
    ...
    public void onSaleContactAddedEventModel(LeadContactAddedEventModel event) {
        ...
        getLoaderManager().restartLoader(LEADS_LOADER_ID, args, BlankFragment3_2.this);
    }
