...
public class DealsDetailsFragment extends TabFragment {
    ...
    public static DealsDetailsFragment newInstance(int page, String title, Long id) {
        DealsDetailsFragment fragmentFirst = new DealsDetailsFragment();
