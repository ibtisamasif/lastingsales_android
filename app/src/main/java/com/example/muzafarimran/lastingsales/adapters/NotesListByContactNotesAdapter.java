...
/**
 * Created by ibtisam on 12/15/2016.
 */

public class NotesListByContactNotesAdapter extends BaseAdapter {
    ...
    public NotesListByContactNotesAdapter(Context mContext,  ArrayList<LSNote> notesList) {
