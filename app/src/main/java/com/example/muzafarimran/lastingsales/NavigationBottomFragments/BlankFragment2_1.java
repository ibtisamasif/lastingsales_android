...
import com.example.muzafarimran.lastingsales.listloaders.UnlabeledLoader1;
...
public class BlankFragment2_1 extends TabFragment implements LoaderManager.LoaderCallbacks<List<Object>> {
    public static final String TAG = "BlankFragment2_1";
    ...
    public BlankFragment2_1() {
    }

    public static BlankFragment2_1 newInstance() {
        BlankFragment2_1 fragment = new BlankFragment2_1();
...
//        args.putLong("someId", id);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_blank2_1, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(HOME_LOADER1_ID, null, BlankFragment2_1.this);
    }
    ...
    public void onSaleContactAddedEventModel(LeadContactAddedEventModel event) {
        ...
        getLoaderManager().restartLoader(HOME_LOADER1_ID, null, BlankFragment2_1.this);
    }
    ...
    public Loader<List<Object>> onCreateLoader(int id, Bundle args) {
        ...
        switch (id) {
            case HOME_LOADER1_ID:
                return new UnlabeledLoader1(getActivity());
            default:
                return null;
        }
    }
