...
public class UnlabeledLoader1 extends AsyncTaskLoader<List<Object>> {
    public static final String TAG = "HomeLoader";
    private List<Object> mData;

    public UnlabeledLoader1(Context context) {
        super(context);
    }
    ...
    public List<Object> loadInBackground() {
        ...
        Collection<LSContact> unlabeledContacts = LSContact.getContactsInDescOrder();
