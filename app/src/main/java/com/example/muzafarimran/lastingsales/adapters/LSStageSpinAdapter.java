...
//    private LSStage[] values;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Then you can get the current item using the values array (LSStages array) and the current position
        // You can NOW reference each method you has created in your bean object (LSStage class)
