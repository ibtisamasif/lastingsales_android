...
public class BlankFragment3_1 extends TabFragment implements LoaderManager.LoaderCallbacks<List<Object>> {
    public static final String TAG = "BlankFragment3_1";
    ...
    public BlankFragment3_1() {
    }

    public static BlankFragment3_1 newInstance() {
        BlankFragment3_1 fragment = new BlankFragment3_1();
...
//        args.putLong("someId", id);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        args = new Bundle();
        args.putString(LeadsLoader.KEY_LEADS_TO_LOAD, LeadsLoader.ALL_LEADS);
        getLoaderManager().initLoader(LEADS_LOADER_ID, args, BlankFragment3_1.this);
    }
    ...
    public void onSaleContactAddedEventModel(LeadContactAddedEventModel event) {
        ...
        getLoaderManager().restartLoader(LEADS_LOADER_ID, args, BlankFragment3_1.this);
    }
