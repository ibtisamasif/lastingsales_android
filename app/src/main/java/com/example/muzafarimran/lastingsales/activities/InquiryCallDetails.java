...
public class InquiryCallDetails extends BottomSheetDialogFragment {
    private static final String TAG = "InquiryCallDetails";
    ...
    public static InquiryCallDetails newInstance(String contact_num, int page) {
        InquiryCallDetails fragmentFirst = new InquiryCallDetails();
