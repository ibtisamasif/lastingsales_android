...
public class HomeAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.bSales = convertView.findViewById(R.id.bSalesUtaggedItem);
            ...
            holder.tvNameFromProfile = convertView.findViewById(R.id.tvNameFromProfile);
            holder.tvCityFromProfile = convertView.findViewById(R.id.tvCityFromProfile);
            holder.tvCountryFromProfile = convertView.findViewById(R.id.tvCountryFromProfile);
            holder.tvWorkFromProfile = convertView.findViewById(R.id.tvWorkFromProfile);
            holder.tvCompanyFromProfile = convertView.findViewById(R.id.tvCompanyFromProfile);
            holder.tvWhatsappFromProfile = convertView.findViewById(R.id.tvWhatsappFromProfile);
            holder.tvTweeterFromProfile = convertView.findViewById(R.id.tvTweeterFromProfile);
            holder.tvLinkdnFromProfile = convertView.findViewById(R.id.tvLinkdnFromProfile);
            holder.tvFbFromProfile = convertView.findViewById(R.id.tvFbFromProfile);
            holder.user_profile_group_wrapper = convertView.findViewById(R.id.user_profile_group_wrapper);
